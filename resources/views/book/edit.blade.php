            ...
            <div class="mb-3">
                ...
                <select class="form-control @error('author') is-invalid @enderror" name="author_id">
                    ...
                    @foreach ($authors as $author)
                        <option value="{{ $author->id }}" {{ isset($book->author) && $book->author->id == $author->id ? 'selected' : '' }}>
                            {{ $author->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <select class="form-control @error('category') is-invalid @enderror" name="category_id">
                    ...
                    @foreach ($categories as $category)
                        <option value="{{ $category->id }}" {{ isset($book->category) && $book->category->id == $category->id ? 'selected' : '' }}>
                            {{ $category->name }}
                        </option>
                    @endforeach
                </select>
